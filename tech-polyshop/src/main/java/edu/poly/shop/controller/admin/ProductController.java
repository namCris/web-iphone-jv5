...
public class ProductController {
	...
	public ModelAndView saveOrUpdate(ModelMap model,
			@Validated @ModelAttribute("product") ProductDto dto,BindingResult result) {
		...
		if(!dto.getImageFile().isEmpty()) {
			UUID uuid = UUID.randomUUID(); //sinh ra dãy ký tự để định dạng
		...
		productService.save(entity);//lưu
